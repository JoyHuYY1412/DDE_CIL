...
class BiasListLayer(nn.Module):
    def __init__(self):
        super(BiasListLayer, self).__init__()
    ...
    def forward(self, outputs, outputs_bias_list):
        return outputs - self.alpha2 * ((1-self.alpha1) * outputs_bias_list[0] + self.alpha1*outputs_bias_list[1])
